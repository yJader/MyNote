...
完善注入信息
    ...
    <bean id="student" class="com.kuang.pojo.Student">
        ...
        <property name="card">
            <map>
                <entry key="身份证" value="9987456321"/>
...
————————————————
版权声明：本文为CSDN博主「黑心白莲」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/li643937579/article/details/109569887