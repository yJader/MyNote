...
**Case 1**: S1没有Term 6的任何Log，因此我们需要**回退**一整个Term的Log
...
**Case 2**: S1收到了任期4的旧Leader的多条Log，但是作为新Leader，S2只收到了一条任期4的Log。所以这里，我们需要覆盖S1中有关旧Leader的一些Log。
...
**Case 3**：S1与S2的Log不冲突，但是S1缺失了部分S2中的Log。
