...
#### 反向传播
**推导过程**: 
对于$W_{i}$的梯度记为($G_{i}$), 由链式法则可得: 
![](10-414%20深度学习系统课程笔记.assets/IMG-10-414%20深度学习系统课程笔记-20250306153440999.png)
可得
$$
\begin{aligned}
G_i&=G_{i+1}\cdot\frac{\partial Z_{i+1}}{\partial Z_i}=G_{i+1}\cdot\frac{\partial\sigma_i(Z_iW_i)}{\partial Z_iW_i}\cdot\frac{\partial Z_iW_i}{\partial Z_i}=G_{i+1}\cdot\sigma^{\prime}(Z_iW_i)\cdot W_i\\
