...
### 通过 Parameter Server 实现数据并行训练

[梯度 g1 被 push 到 Parameter server, 更新后的 w1 被 pull 下来]
...
[$X$ (replicated) -> $W$ (row-sharded) -> $Y$ (row-sharded) -> allgather -> $Y$ (replicated)]
